...
public class HeardBeat  implements Serializable {
    ...
    public String toString() {
        int horas = Calendar.getInstance().get(Calendar.HOUR) - calendar.get(Calendar.HOUR);
        int minutos = Calendar.getInstance().get(Calendar.MINUTE) - calendar.get(Calendar.MINUTE);
        int segundos = Calendar.getInstance().get(Calendar.SECOND) - calendar.get(Calendar.SECOND);
        ...
        return "HeardBeat{" +
                ...
                ",Tempo decorrido desde o ultimo heartbeat: " + horas + " : " + minutos + " : " + segundos +
                ",Rmi port: " + portRMI +
                '}' + "\n";
    }
